...
and M4ConcreteComponent.
 ...
 ### Decorator Pattern
* The Decorator Pattern is used to decorate any gun the player wants to customize. Each of the gun concrete components have three functions: 
> 1. AddAttachment(): allows the player to add an attachment (Concrete Decorator) to the gun 
> 2. RemoveAttachment(): allows the player to remove an attachment from the gun
> 3. getCost(): computes the cost of the gun and the attachments it is decorated with
